...
public class PlayerConstants {
    ...
    public interface ACTION {
        String ACTION_PLAY_PREV_SONG = "com.chsapps.yt_hongjinyoung.action.prev";
        String ACTION_PLAY_OR_PAUSE = "com.chsapps.yt_hongjinyoung.action.play";
        String ACTION_PLAY_NEXT_SONG = "com.chsapps.yt_hongjinyoung.action.next";
        String ACTION_START_FORGROUNT_WEB = "com.chsapps.yt_hongjinyoung.action.playingweb";
        String ACTION_STOP_FORGROUNT_WEB = "com.chsapps.yt_hongjinyoung.action.stopplayingweb";
        String ACTION_SET_YOUTUBE_PLAYER_TYPE = "com.chsapps.yt_hongjinyoung.action.player_type";
        String ACTION_CLOSE_PLAYER = "com.chsapps.yt_hongjinyoung.action.close_player";
    }
