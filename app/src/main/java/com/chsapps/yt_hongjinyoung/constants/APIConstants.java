...
public class APIConstants {
    public static final String API_APPLICATION = "applicationkey";
    public static final String API_KEY = "allsoft2018";
    ...
    public static final String API_TEST_SERVER_URL = "https://api-wise-test-dot-calllocker-94b36.appspot.com";
