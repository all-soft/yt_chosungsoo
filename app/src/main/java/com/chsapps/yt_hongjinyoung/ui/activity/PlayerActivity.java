...
import com.chsapps.yt_hongjinyoung.ui.fragment.play_song.PlaySongMainFragment;
import com.chsapps.yt_hongjinyoung.utils.AdUtils;

public class PlayerActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    @Override
    protected void initialize() {
        setHavePlayer(false);
        setDrawerLayout(false);
        setSupportActionBar();
        replace(R.id.layout_main, PlaySongMainFragment.newInstance(getIntent().getExtras()), PlaySongMainFragment.TAG, false, false);
    }
