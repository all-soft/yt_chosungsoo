...
import com.chsapps.yt_hongjinyoung.ui.fragment.MainGenreSongListFragment;
...
public class CategoryPlaySongActivity extends BaseActivity {
    public final static String TAG = CategoryPlaySongActivity.class.getSimpleName();
    ...
    protected void initialize() {
        ...
        replace(R.id.layout_main, MainGenreSongListFragment.newInstance(getIntent().getExtras()), MainGenreSongListFragment.TAG, false, false);
    }
