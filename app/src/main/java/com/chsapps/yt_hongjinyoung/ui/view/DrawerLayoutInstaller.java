...
//                drawerLayout.setStatusBarBackgroundColor(activity.getResources().getColor(R.color.style_color_primary_dark));
            ...
            if (toolbar != null) {
                toolbar.setNavigationOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        } else if (drawerLayout.getDrawerLockMode(Gravity.START) == DrawerLayout.LOCK_MODE_UNLOCKED) {
        ...
        private void setupDrawerLeftView(DrawerLayout drawerLayout) {
            if (drawerLeftView != null) {
                ((ViewGroup) drawerLayout.getChildAt(0))
