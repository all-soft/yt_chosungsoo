...
public class MainPopularFragment extends BaseFragment implements SongListHolderListener {
    public final static String TAG = MainPopularFragment.class.getSimpleName();
    ...
    @BindView(R.id.popular_list_view)
    RecyclerView popular_list_view;
    ...
    public static MainPopularFragment newInstance(Bundle bundle) {
        if (bundle == null) {
            bundle = new Bundle();
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return mainView = inflater.inflate(R.layout.fragment_main_popular, null);
    }
    ...
    private void initListView() {
        ...
        if (adapter == null) {
            adapter = new MainPapularAdapter(parentActivity, true, this);
        }
        adapter.setSelectedSongDataMap(selectedAdapter);
        popular_list_view.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false));
        popular_list_view.setHasFixedSize(true);
        popular_list_view.setAdapter(adapter);
    }

    @OnClick(R.id.btn_all_play)
    public void onClick_btn_all_play() {
    }
