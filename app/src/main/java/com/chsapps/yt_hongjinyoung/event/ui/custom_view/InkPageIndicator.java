...
public class InkPageIndicator extends View implements ViewPager.OnPageChangeListener,
    ...
    private int countForInfinite = -1;
    public void setViewPager(ViewPager viewPager, final int count) {
        this.viewPager = viewPager;
        this.countForInfinite = count;
        viewPager.addOnPageChangeListener(this);
        setPageCount(countForInfinite);
...
//                return;
//            }
//            if(countForInfinite > 0) {
//                position = position % countForInfinite;
//            }
////            LogUtil.e("HSSEO", "POSITION 2 : " + position + " / " + countForInfinite);
...
////                }
//            }
//            LogUtil.e("HSSEO", "POSITION 1 : " + position + " / " + leftDotPosition + " / " + fraction);
////            setJoiningFraction(leftDotPosition, 0.0f);
//        }
    }
    ...
    private void setCurrentPageImmediate() {
        if (viewPager != null) {
            ...
            if(countForInfinite > 0) {
                currentPage = currentPage % countForInfinite;
            }
        } else {
            currentPage = 0;
        }
